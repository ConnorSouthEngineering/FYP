...
BEGIN
    ...
    IF FOUND THEN
        IF _existing_node_id IS NULL AND _node_id IS NULL THEN/*key is not yet mapped to a device*/
        ...
        ELSIF _existing_node_id = _node_id THEN /*key is already mapped to the same device*/
            UPDATE nodes
